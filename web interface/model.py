...
class GPTModel:
    ...
    def summarize(self, user_message):
        return self.generate_text(user_message + ' summarize this text. If all is correct, say *all is correct*. If there are also comments, say Yes/No and comments.')

model = GPTModel('shds-XmmYuTrBLXlEaJZx9chDSiocOXw')
